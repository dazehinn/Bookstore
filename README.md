...
**Bookstore** is a Single Page App (SPA) that permits users to display all books, add new books to the list and remove selected books
...
- [ ] **Implement feature to delete selected books**
